...
(function () {
  ...
  function cacheKey(ch) { return 'book_bai_v1_' + hashStr(ch.textWen.join('|')); }
  ...
  function buildPrompt(ch) {
    return '请把下面这篇文言文列传翻译成现代白话文。要求：\n'
      ...
      + '四、纪年换算：文中干支或私撰年号纪年，换算为公元年份并在其后括注共和国周年——中华人民共和国以一九四九年十月一日成立，周年自该日算起；事件在当年十月一日之前的，周年按上一年计（例如“乙酉岁正月”即2005年正月，在国庆之前，应写作“2005年（共和国五十五年）正月”）；\n'
      + '五、译文通顺自然，符合现代汉语习惯。\n\n'
      + ch.textWen.join('\n');
  }
