...
(function () {
  ...
  function cacheKey(ch) { return 'book_bai_v2_' + hashStr(ch.textWen.join('|') + (ch.eraNote || '')); }
  ...
  function buildPrompt(ch) {
    return '请把下面这篇文言文列传翻译成现代白话文。要求：\n'
      ...
      + '四、纪年换算：干支或私撰年号纪年须换算为公元年份，并以「共和国X年（公元YYYY年）」格式括注。中华人民共和国以一九四九年十月一日成立，周年自该日算起：事件在当年十月一日及以后的，周年=该年份-1949；在十月一日之前的，周年=该年份-1950。例如2005年2月在国庆之前，应写作「共和国五十五年（公元2005年）」；2005年10月1日之后才写作「共和国五十六年（公元2005年）」。严禁出现「共和国前XX年」这类公元前式表述，严禁把年份算错；\n'
      + '五、译文通顺自然，符合现代汉语习惯。\n'
